...
As you can imagine, if I'm writting this post is because I haven't found a clear answer to all these questions. In my search I have gained more doubts than answers, but I have realized this is not an unaddressed issue but rather a hard one to close. With this post's demonstrations I have finally concluded that the order does matter, but it depends on the methodologies applied for filtering and normalizing.
